...
/**
 * This is a Kit API, used to register the Kits to
 * the arena. Used by players.
 *
...
abstract class KitsAPI {
	 ...
	 * which set the kit ID variables.
	 */
	public function __construct(){
		$this->kitID = Kits::$kitsID++;
	}
	...
	/**
	 * The EID for the Kits, This will be used to bind
	 * what kit that this is without making it hard.
	 *
	 * @return int
	 */
	public function getKitEID(): int{
		return $this->kitID;
	}

	/**
	 * Start to listen to events by fetching
	 * this to the plugin. Its will only be listened to
